            ...
            <div className="flex h-16 justify-between">
              <div className="flex">
                <div className="flex flex-shrink-0 items-center">
                  <Link to="/" className="text-xl font-bold text-text flex gap-2 items-center group">
                    ...
                    <span className="bg-gradient-to-r from-text to-muted bg-clip-text text-transparent font-extrabold">
                      GZW Ammo Analyzer
                    </span>
                  </Link>
                </div>
                  ...
                  {navigation.map((item) => {
                    ...
                    return (
                      <Link
                        key={item.name}
                        to={item.href}
                        className={`inline-flex items-center px-3 py-1 text-sm font-medium rounded-md transition-all duration-200 ${
                          current
              ...
              <div className="flex items-center">
                ...
                <div className="flex items-center sm:hidden ml-4">
                  {/* Mobile menu button */}
                  <Disclosure.Button className="relative inline-flex items-center justify-center rounded-md p-2 text-muted hover:bg-accent/10 hover:text-text focus:outline-none focus:ring-2 focus:ring-inset focus:ring-accent transition-colors">
                ...
                {navigation.map((item) => {
                  ...
                  return (
                    <Link
                      key={item.name}
                      to={item.href}
                      className={`block w-full text-left rounded-md px-3 py-2 text-base font-medium transition-all duration-200 ${
                        current
