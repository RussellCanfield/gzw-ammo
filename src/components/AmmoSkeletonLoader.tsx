      ...
      <div className="bg-secondary rounded-lg shadow-lg p-6 mb-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <div className="h-4 w-16 bg-gray-700 rounded mb-1"></div>
            <div className="flex">
              <div className="h-10 flex-grow bg-gray-700 rounded-l"></div>
              <div className="h-10 w-10 bg-gray-700 rounded-r"></div>
            </div>
          </div>
        </div>
      </div>
              ...
              <div>
                ...
                <div className="mb-3">
                  ...
                  <div className="flex space-x-1 mb-2">
                    {[1, 2, 3].map((i) => (
                      <div key={`helmet-${i}`} className="h-4 flex-1 bg-gray-700 rounded"></div>
                    ))}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex space-x-1">
                    {[1, 2, 3, 4].map((i) => (
                      <div key={`body-${i}`} className="h-4 flex-1 bg-gray-700 rounded"></div>
                    ))}
                  </div>
                </div>
              </div>
