...
export const HELMET_ARMOR_LEVELS: Extract<
	ArmorLevel,
	"IIA" | "IIIA" | "IIIA+"
>[] = ["IIA", "IIIA", "IIIA+"];
export const BODY_ARMOR_LEVELS: Extract<
	ArmorLevel,
	"IIIA" | "IIIA+" | "III" | "III+"
>[] = ["IIIA", "IIIA+", "III", "III+"];
...
export const penetrationColorClass = (value: PenetrationValue): string => {
	switch (value) {
		case 0:
			return "bg-green-500"; // No penetration (Green)
		case 1:
			return "bg-yellow-500"; // Low penetration (Yellow)
		case 2:
			return "bg-orange-500"; // Medium penetration (Orange)
		case 3:
			return "bg-red-600"; // High penetration (Red)
		default:
			return "bg-gray-400";
	}
};
